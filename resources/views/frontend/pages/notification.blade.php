                                ...
                                <tbody>
                                    ...
                                    @elseif($type == 'admission-notices')
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="documents/academic-calendar-2025.pdf"
                                                    class="btn btn-sm btn-primary"><i class="fa fa-download"></i>
                                                    Download</a></td>
                                        </tr>
                                    @elseif($type == 'examination-notices')
                                        <!-- Notification with sub-points -->
                                        <tr>
                                            <td>10-Mar-2025</td>
                                            <td>
                                            ...
                                            <td><a href="documents/midterm-schedule-2025.pdf"
                                                    class="btn btn-sm btn-primary"><i class="fa fa-download"></i>
                                                    Download</a></td>
                                        </tr>
                                    @else
